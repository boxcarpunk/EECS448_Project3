...
*/
	...
	if((instance_number(obj_Slime) > 3) && (room_get_name(room) == "room1")&& (room.BossSpawned == false)) //if there are at least four slimes in the room, the boss has not spawned, and you are in the boss room
	{
