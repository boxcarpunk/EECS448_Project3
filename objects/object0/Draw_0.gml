...
scr_slider(camera_get_view_x(view_camera[0]) + profileSize + healthOffset + profileOffsetX, camera_get_view_y(view_camera[0]) + profileSize + healthOffset, borderWidth,  healthLength, healthHeight, healthLength*PlayerHealth/MaxPlayerHealth, borderColor, c_red, c_green);
...
cooldown1TimeLeft = (MaxProjCount - ProjCount)/MaxProjCount;
