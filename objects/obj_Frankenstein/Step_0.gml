...
*/
	...
	if(Health > 0)
	{
		...
		{
			//attack animation
			if(sprite_index != AttackAnimation) //if the attack animation is not playing
			{
				sprite_index = AttackAnimation; //switch to the attack animation
				image_index = 0; //start at the beginning of the animation
				image_speed = 1; //play the animation
			}
		...
		if((image_index > AttackEndFrame) && (sprite_index == AttackAnimation)) //if the attack animation is done playing
		{
			sprite_index = DefaultSprite; //switch to the default animation
			image_index = 0; //start at the beginning of the animation
			image_speed = 1; //play the animation
		}
	}
